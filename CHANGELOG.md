...
- Enable macOS testing [\#19](https://github.com/yykamei/thwack/pull/19) ([yykamei](https://github.com/yykamei))
- Rename the project to thwack [\#18](https://github.com/yykamei/thwack/pull/18) ([yykamei](https://github.com/yykamei))
...
- Disable Clippy on super-linter and run it on our own [\#12](https://github.com/yykamei/thwack/pull/12) ([yykamei](https://github.com/yykamei))
- Handle errors and warnings by clippy [\#11](https://github.com/yykamei/thwack/pull/11) ([yykamei](https://github.com/yykamei))
